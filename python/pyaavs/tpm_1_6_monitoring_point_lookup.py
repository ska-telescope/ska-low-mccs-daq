...
def load_tpm_1_6_lookup(obj):
    return {
        ...
        'voltages': {
            'VREF_2V5': {"method": partial(obj.get_voltage, voltage_name='VREF_2V5'), "exp_value": 0, "rate": ["fast"], "group": ["voltages"]},
            'MGT_AVCC': {"method": partial(obj.get_voltage, voltage_name='MGT_AVCC'), "exp_value": 0, "rate": ["fast"], "group": ["voltages"]},
            ...
            'AVDD3': {"method": partial(obj.get_voltage, voltage_name='AVDD3'), "exp_value": 0, "rate": ["fast"], "group": ["voltages"]},
            'MAN_1V2': {"method": partial(obj.get_voltage, voltage_name='MAN_1V2'), "exp_value": 0, "rate": ["fast"], "group": ["voltages"]},
            'DDR0_VREF': {"method": partial(obj.get_voltage, voltage_name='DDR0_VREF'), "exp_value": 0, "rate": ["fast"], "group": ["voltages"]},
            'DDR1_VREF': {"method": partial(obj.get_voltage, voltage_name='DDR1_VREF'), "exp_value": 0, "rate": ["fast"], "group": ["voltages"]},
            'VM_DRVDD': {"method": partial(obj.get_voltage, voltage_name='VM_DRVDD'), "exp_value": 0, "rate": ["fast"], "group": ["voltages"]},
            'VIN': {"method": partial(obj.get_voltage, voltage_name='VIN'), "exp_value": 0, "rate": ["fast"], "group": ["voltages"]},
            'MON_3V3': {"method": partial(obj.get_voltage, voltage_name='MON_3V3'), "exp_value": 0, "rate": ["fast"], "group": ["voltages"]},
            'MON_1V8': {"method": partial(obj.get_voltage, voltage_name='MON_1V8'), "exp_value": 0, "rate": ["fast"], "group": ["voltages"]},
            'MON_5V0': {"method": partial(obj.get_voltage, voltage_name='MON_5V0'), "exp_value": 0, "rate": ["fast"], "group": ["voltages"]},
            ...
            'VM_DDR1_VDD': {"method": partial(obj.get_voltage, voltage_name='VM_DDR1_VDD'), "exp_value": 0, "rate": ["fast"], "group": ["voltages"]},
            'VM_DDR1_VTT': {"method": partial(obj.get_voltage, voltage_name='VM_DDR1_VTT'), "exp_value": 0, "rate": ["fast"], "group": ["voltages"]},
            'VM_DVDD': {"method": partial(obj.get_voltage, voltage_name='VM_DVDD'), "exp_value": 0, "rate": ["fast"], "group": ["voltages"]},
        ...
        'currents': {
             'FE0_mVA': {"method": partial(obj.get_current, current_name='FE0_mVA'), "exp_value": 0, "rate": ["fast"], "group": ["currents"]},
            'FE1_mVA': {"method": partial(obj.get_current, current_name='FE1_mVA'), "exp_value": 0, "rate": ["fast"], "group": ["currents"]}
        },
