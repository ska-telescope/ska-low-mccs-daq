...
class MccsDaqReceiver(MccsBaseDevice[DaqComponentManager]):
    ...
    VerifyEvents = device_property(
        dtype=bool,
        doc="Whether to register change and archive events with detect=True",
    ...
    def initialise_change_events(self: MccsDaqReceiver) -> None:
        ...
        self.set_change_event("dataReceivedResult", True, self.VerifyEvents)
        self.set_archive_event("dataReceivedResult", True, self.VerifyEvents)
        self.set_change_event("xPolBandpass", True, self.VerifyEvents)
        self.set_archive_event("xPolBandpass", True, self.VerifyEvents)
        self.set_change_event("yPolBandpass", True, self.VerifyEvents)
        self.set_archive_event("yPolBandpass", True, self.VerifyEvents)
        self.set_change_event("rawXPolBandpass", True, self.VerifyEvents)
        self.set_archive_event("rawXPolBandpass", True, self.VerifyEvents)
        self.set_change_event("rawYPolBandpass", True, self.VerifyEvents)
        self.set_archive_event("rawYPolBandpass", True, self.VerifyEvents)
        self.set_change_event("rmsPlot", True, self.VerifyEvents)
        self.set_archive_event("rmsPlot", True, self.VerifyEvents)
        self.set_change_event("nofSaturations", True, self.VerifyEvents)
        self.set_archive_event("nofSaturations", True, self.VerifyEvents)
        self.set_change_event("nofPackets", True, self.VerifyEvents)
        self.set_archive_event("nofPackets", True, self.VerifyEvents)
        self.set_change_event("relativeNofPacketsDiff", True, self.VerifyEvents)
        self.set_archive_event("relativeNofPacketsDiff", True, self.VerifyEvents)
        self.set_change_event("nofSamples", True, self.VerifyEvents)
        self.set_archive_event("nofSamples", True, self.VerifyEvents)
        self.set_change_event("relativeNofSamplesDiff", True, self.VerifyEvents)
        self.set_archive_event("relativeNofSamplesDiff", True, self.VerifyEvents)
        self.set_change_event("dataRate", True, self.VerifyEvents)
        self.set_archive_event("dataRate", True, self.VerifyEvents)
        self.set_change_event("receiveRate", True, self.VerifyEvents)
        self.set_archive_event("receiveRate", True, self.VerifyEvents)
        self.set_change_event("dropRate", True, self.VerifyEvents)
        self.set_archive_event("dropRate", True, self.VerifyEvents)
        self.set_change_event("ringbufferOccupancy", True, self.VerifyEvents)
        self.set_archive_event("ringbufferOccupancy", True, self.VerifyEvents)
        self.set_change_event("lostPushes", True, self.VerifyEvents)
        self.set_archive_event("lostPushes", True, self.VerifyEvents)
        self.set_change_event("lostPushRate", True, self.VerifyEvents)
        self.set_archive_event("lostPushRate", True, self.VerifyEvents)
        self.set_change_event("correlatorTimeTaken", True, self.VerifyEvents)
        self.set_archive_event("correlatorTimeTaken", True, self.VerifyEvents)
        self.set_change_event("correlatorSolveTime", True, self.VerifyEvents)
        self.set_archive_event("correlatorSolveTime", True, self.VerifyEvents)
        self.set_change_event("hostToDeviceCopyTime", True, self.VerifyEvents)
        self.set_archive_event("hostToDeviceCopyTime", True, self.VerifyEvents)
        self.set_change_event("deviceToHostCopyTime", True, self.VerifyEvents)
        self.set_archive_event("deviceToHostCopyTime", True, self.VerifyEvents)
        self.set_change_event("correlatorTimeUtil", True, self.VerifyEvents)
        self.set_archive_event("correlatorTimeUtil", True, self.VerifyEvents)
        self.set_change_event("bufferCounter", True, self.VerifyEvents)
