...
class DaqStub(object):
    ...
    def __init__(self, channel):
        ...
        self.InitDaq = channel.unary_unary(
                '/Daq/InitDaq',
                request_serializer=daq__pb2.noParamRequest.SerializeToString,
                response_deserializer=daq__pb2.commandResponse.FromString,
                )
...
def add_DaqServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'InitDaq': grpc.unary_unary_rpc_method_handler(
                    servicer.InitDaq,
                    request_deserializer=daq__pb2.noParamRequest.FromString,
                    response_serializer=daq__pb2.commandResponse.SerializeToString,
            ),
...
class Daq(object):
    ...
    def StartDaq(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Daq/StartDaq',
    ...
    def StopDaq(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Daq/StopDaq',
    ...
    def InitDaq(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Daq/InitDaq',
            daq__pb2.noParamRequest.SerializeToString,
            daq__pb2.commandResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def ConfigureDaq(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Daq/ConfigureDaq',
