...
if __name__ == "__main__":
    ...
    if sum([conf.plot_beam_data, conf.plot_raw_data, conf.plot_channel_data,
            conf.plot_integrated_channel_data, conf.plot_integrated_beam_data,
            conf.plot_cont_channel_data, conf.plot_station_beam_data,
            conf.plot_correlated_data]) != 1:
