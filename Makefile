...
K8S_CHART_PARAMS = \
	...
	--set ska-tango-devices.deviceServerTypes.calibration-daq.image.registry=$(CI_REGISTRY_IMAGE) \
	--set ska-tango-devices.deviceServerTypes.calibration-daq.image.tag=$(VERSION)-dev.c$(CI_COMMIT_SHORT_SHA) \
