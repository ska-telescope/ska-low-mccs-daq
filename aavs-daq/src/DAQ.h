...
public:
    ...
    // Set diagnostic callback for ring buffer
    void setDiagnosticCallback(DiagnosticCallback callback)
    {
        if (ring_buffer != nullptr)
            ring_buffer->set_diagnostic_callback(callback);
    }
...
RESULT startConsumer(const char* consumer, DataCallback callback=nullptr, DiagnosticCallback diagnostic_callback = nullptr);
RESULT startConsumerDynamic(const char* consumer, DataCallbackDynamic callback=nullptr, DiagnosticCallback diagnostic_callback = nullptr);
