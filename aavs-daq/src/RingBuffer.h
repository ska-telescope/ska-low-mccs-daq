...
typedef void (*DiagnosticCallback)(void*  diagnostics);

struct RingbufferDiagnostics
{
    double ringbuffer_occupancy;      // Ring buffer occupancy in %
    size_t lost_pushes;               // Number of lost packets
};
...
public:
    ...
    {
        this->diagnostic_callback = callback;
    }
